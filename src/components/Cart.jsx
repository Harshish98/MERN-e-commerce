...
export const Cart = () => {
  ...
  const { fetchCartProducts, deleteCartProduct, showCartProducts } =
          ...
          <div className="md:w-4/5 lg:w-3/5 mx-auto px-3">
            <div className="">
              {showCartProducts.map((val, index) => (
                <div
                  key={index}
                  className="flex justify-between items-center shadow-md p-4 text-[#2c4152]"
                >
                  ...
                  <div className="flex space-x-2">
                    ...
                    <input
                      type="number"
                      value={quantities[val._id]}
                      className="border border-[#2c4152] w-12 md:w-16 px-4 rounded-md"
                      onChange={(e) =>
                        handleQuantityChange(val._id, parseInt(e.target.value))
                      }
                    />
                  </div>
                  <div className="">
            ...
            <div className="border shadow-md p-2 w-60 h-fit mt-5">
              ...
              <p>Total: {total}&#8377;</p>
              {/* <button className="w-full text-white py-2 bg-[#2c4152]">
                Proceed to checkout
              </button> */}
              <BuyNow />
            </div>
