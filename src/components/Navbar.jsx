...
export const Navbar = () => {
  ...
  return (
    <>
      <div className="md:flex md:justify-between space-y-2 md:space-y-0 xl:justify-around items-center px-2 py-3 lg:p-4 border border-b-gray-200 shadow-[0_2px_3px_rgba(0,0,0,.2)] fixed top-0 right-0 left-0 bg-white overflow-hidden z-10">
        ...
        <div
          className={`${
            showMenu
              ? "visible space-y-2 md:space-y-0 md:flex justify-between items-center md:space-x-3"
              : "hidden"
          }`}
        >
              ...
              <CustomTooltip
                title={
                  token ? (
                    ...
                    <Link to="/login">
                      <button className="bg-blue-700 text-white rounded-md w-20 py-1">
                        Log In
                      </button>
                    </Link>
                  )
              ...
              <Link to="/wishlist">
                <div className="relative">
                  ...
                  <p
                    ...
                    } absolute -top-3 left-3 bg-[#2c4152] rounded-full text-white w-5 h-5 flex items-center justify-center text-xs`}
                  >
                    {wishlistCount}
                  </p>
                </div>
