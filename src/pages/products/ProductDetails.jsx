...
export const ProductDetails = () => {
  const { fetchSpecificProduct, specificProduct, loading } =
    useContext(ProductContext);
  const { handleAddToCart } = useContext(CartContext);
  const { addToWishlist, removeWishlistProduct, fetchWishlistProducts } =
  ...
  const toggleWishlist = () => {
    if (token) {
      if (wishlisted) {
        removeWishlistProduct(specificProduct._id);
      } else {
